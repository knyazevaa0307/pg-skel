...
echo "Creating $$DB_NAME..." && echo su -c \"createdb -T template0 $$DB_LOC $$DB_NAME\" postgres && \
echo "Updating $$DB_NAME extensions..." && echo psql -d $$DB_NAME -U postgres -f $$SRC/setup.sql ; \
echo "Done"
endef
export EXP_SCRIPT
